...
class MyProvider(BaseProvider):
    ...
    def types(self):
        types = ['ASSAULT', 'BATTERY', 'BURGLARY', 'CRIMINAL DAMAGE', 
        'MOTOR VEHICLE THEFT', 'NARCOTICS', 'OFFENSE INVOLVING CHILDREN', 'OTHER OFFENSE']
        return choice(types)
    ...
    def location_description(self):
        ...
        "RESIDENCE", "OFFICE","STREET", "PARKING LOT", "STORE", "PARKING"
    ]
...
def datagenerate(records, headers):
    ...
    with open("Crimes_2001_to_Present.csv", 'a') as csvFile:
        ...
        #writer.writeheader() #Only while creating a new file
        for i in range(records):
            ...
            writer.writerow({
                    ...
                    "Date": fake.date_time_this_year().strftime('%x %X') + ' ' + fake.am_pm(),
                    ...
                    "Year": fake.date_between_dates(datetime.date(2000,1,1), datetime.date(2022,1,1)).year,
...
records = 100000000
headers = [ "ID","Case_Number","Date","Block","IUCR","Primary_Type","Description","Location_Description","Arrest","Domestic",
        "Beat","District","Ward","Community_Area","FBI_Code","XCoordinate","YCoordinate","Year","Updated_On","Latitude","Longitude","Location" ]
